    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href={{ route('admin.index') }}>
                ...
                <div class="sidebar-brand-text mx-3">Gib Nguyen Blog</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href={{ route('admin.category.add') }}>Add</a>
                        {{-- <a class="collapse-item" href={{ route('admin.category.edit') }}>Edit</a> --}}
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href={{ route('admin.user.add') }}>Add</a>
                        {{-- <a class="collapse-item" href={{ route('admin.user.edit') }}>Edit</a> --}}
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href={{ route('admin.post.index') }}>List</a>
                        <a class="collapse-item" href={{ route('admin.post.add') }}>Add</a>
                        {{-- <a class="collapse-item" href={{ route('admin.post.edit') }}>Edit</a> --}}
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item  no-arrow mx-1">
                            <a class="nav-link " href="/" id="alertsDropdown" role="button"
                                >
                                <i class="fas fa-home fa-fw  " style="font-size:36px"></i>
                            </a>
